		...
		<>
			<Layout title={product.name}>
				...
				<div className="product-description">
					...
					<p className="text2">
						Made from high quality ingredients including a minimum of 34%
						chicken, Hills Science Plan Canine Puppy Large Breed is infused
						with:
					</p>
					...
					<ul className="text3">
						...
						<li>
							High Quality Protein – to support healthy growth and strong
							muscles;
						</li>
						<li>
					...
					<ul className="text4">
						...
						<li>
							Suitable for puppies from weaning up to 1 year old whose adult
							body weight will exceed 25kg.
						</li>
						<li>
